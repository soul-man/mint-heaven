...
const Audit = () => {
  return (
    <div className="mx-auto max-w-7xl flex flex-row justify-center items-center mb-44 gap-5 xl:gap-8">
      ...
      <div className="w-full h-full md:w-6/12">
        ...
        <div className='w-full p-4 md:p-6 xl:p-10 flex flex-col md:flex-row gap-5 md:gap-10 rounded-lg justify-center items-center bg-black/10 border-1 border-dashed border-blue-900/40'>
          ...
          <div className="w-12/12 md:w-9/12 flex flex-col items-center md:items-start">
            <span className="text-white font-thin text-lg md:text-xl mb-5 text-center md:text-left">Our NFTs are created with help <span className="font-medium">AI</span></span>
            <div className='
              flex 
              items-center 
              gap-3 
