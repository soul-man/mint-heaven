  ...
  return (
    <div className='grad w-screen bg-gradient-to-b from-slate-900 from-20% to-slate-950 to-90%'>
      <div className='relative w-full max-w-xl'>
        ...
        <div className='blob2 animate-blob absolute left-[18vw] top-36 rounded-full bg-blue-600 opacity-10 mix-blend-lighten blur-2xl filter animation-delay-4000'></div>
      </div>
      <Seo />
